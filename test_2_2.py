...
prefix = 'lstm_'
model_identifier='DHW_4'
dataset_identifier='DHW_4'
...
def train(model, X_train, y_train,X_val, y_val, 
    ...
    early_stopping = EarlyStopping(monitor='loss', mode='min', min_delta=0.00000001, patience=patience, verbose=verbose)
...
def plot_the_results(predicted_values, y_test, sp, intervals, scaling_factor):
...
plot_the_results(prediction_testset, y_test, sp, intervals, scaling_factor)
