# -*- coding: utf-8 -*-
"""
Created on Sat Oct  6 01:12:20 2018
...
import sys
  ...
  sys.path.append('C:\Users\leoliu\Dropbox\learning_kh\master thesis\eon acs\my work\model\ann_forecast')
...
#import ann_forecast.utils.utils as utils
#import ann_forecast.config as config
#from ann_forecast.ann_abstr import Ann_model
#from ann_forecast.metrics import mean_neg_log_loss_parametric, mean_neg_log_loss_discrete
...
matrix_load = convertSeriesToMatrix(list_5mins_load, sequence_length)
